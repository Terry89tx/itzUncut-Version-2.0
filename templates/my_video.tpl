...
<TD style="PADDING-RIGHT: 0px">
                                ...
                                <tr>
                                  ...
                                  <th background="images/nv_2_bg.jpg"><div align="left">
                                      <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          <td class="white_bold">My Videos</td>
        ...
        <TR vAlign=top>
                ...
                <INPUT type=submit value="Edit Video" name="Edit Video">
                </FORM>
                <FORM name=removeVideoForm action="{$baseurl}/my_video.php" method=post>
                <INPUT type=hidden value=1 name=action_removevideo>
                <INPUT type=hidden value={$answers[i].VID} name="VID">
                <INPUT onclick="return confirm('Are you sure you want to remove this video?');" type=submit value="Remove Video" name="remove_video">
                </FORM>
                </TD>
                <TD width="64%">
                ...
                <P>Broadcast: <SPAN style="FONT-WEIGHT: bold; COLOR: #007700">{$answers[i].type} Video</SPAN> </P>
                <P>Status: <A href="{$baseurl}/help.php">Live!</A> </P>
                <P>
                <INPUT style="FONT-SIZE: 10px; TEXT-ALIGN: center" readOnly size=62
                 value="{$baseurl}/view_video.php?viewkey={$answers[i].vkey}" name=video_link></P>
                <P>Share this video with friends! Copy and paste the link above to an email or website.</P>
                </DIV>
                </TD>
        </TR>
        </TBODY>
