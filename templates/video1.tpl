<tr>
                <td align="center" valign="top"><table width="760"  border="0" cellspacing="0" cellpadding="0">
                  ...
                  <td height=5>&nbsp;</td></tr>
                  <tr><td width=760>
<TABLE cellSpacing=0 cellPadding=0 width=760 align=center bgColor=#cccccc border=0>
<TBODY>
        <TR>
        <TD width=760>
                            ...
                            <tr>
                              <td align="center"><table width="760"  border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  ...
                                  <th background="images/nv_2_bg.jpg"  width=760><div align="left">
                                      <table width="760"  border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          <td class="white_bold" width="319">{if $smarty.request.category eq ""}{assign var="catgy" value=mr}{else}{assign var="catgy" value=$smarty.request.category}{/if}
