...
<BODY>
                        ...
                        <form action='audioedit.php?a={$smarty.request.a}action=edit&VID={$video.VID}&page={$smarty.request.page}&sort={$smarty.request.sort}' method='POST'>
                        <table width="70%" align="center" cellpadding="3" cellspacing="3">
                        <tr><td><h3>Edit audio</h3></td><td align='right'><a href='audios.php?a={$smarty.request.a}&page={$smarty.request.page}&sort={$smarty.request.sort}'>Back</a></td></tr>
