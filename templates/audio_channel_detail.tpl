...
<TD ><!-- Begin Most Active Users in the Channel Section -->
        ...
        <TABLE cellSpacing=0 cellPadding=0 width=580 align=center bgColor={$bgcolor} border=0>
        <TBODY>
        <tr>
				    ...
				    <img src="images/nv_2_l.jpg" width="5" height="24" alt=""></td>
...
<!-- Begin Recently Added to Channel Section -->
        ...
        <tr>
                              <td height="24" valign=top><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td width="5" height="24" background="images/nv_2_l.jpg">
				    <img src="images/nv_2_l.jpg" width="5" height="24" alt=""></td>
                                    <th background="images/nv_2_bg.jpg" align=left><span class="white_bold" align=left>Recently Added to {$answers[0].name}</span></th>
	...
	<A href="{$baseurl}/view_audio.php?viewkey={$recadd[j].vkey}">
		      <IMG  height=70 src="{$tmburl}/audio.png" border=0v>
	</A>
        
	<DIV class=moduleEntrySpecifics style="FONT-WEIGHT: bold; PADDING-TOP: 5px">
        <A href="{$baseurl}/view_audio.php?viewkey={$recadd[j].vkey}">{$recadd[j].title}</A></DIV>
        <DIV class=moduleEntrySpecifics>By:
        {insert name=id_to_name assign=uname un=$recadd[j].UID}
        <A href="{$baseurl}/uprofile.php?UID={$recadd[j].UID}">{$uname}</A></DIV>
        <DIV class=moduleEntrySpecifics>Runtime: {$recadd[j].duration|string_format:"%.2f"}</DIV>
...
<!-- Begin Top Watched in Channel Section -->
        ...
        <tr>
                              <td height="24" valign=top><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <th background="images/nv_2_bg.jpg" align=left><span class="white_bold" align=left>Top Watched audios in {$answers[0].name} Channel</span></th>
        ...
        <TD style="WIDTH: 20%; TEXT-ALIGN: center" vAlign=top>
        <A href="{$baseurl}/view_audio.php?viewkey={$mostview[k].vkey}">
		      <IMG  height=70 src="{$tmburl}/audio.png" border=0v>
	</A>
        <DIV class=moduleEntrySpecifics style="FONT-WEIGHT: bold; PADDING-TOP: 5px">
        <A href="{$baseurl}/view_audio.php?viewkey={$mostview[k].vkey}">{$mostview[k].title}</A></DIV>
        <DIV class=moduleEntrySpecifics>By:
...
<table>
        <tr>
                              <td height="24" valign=top><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                   ...
                                   <tr>
                                    <td width="3" height="24"><img src="images/nv_2_l.jpg" width="3" height="28" alt=""></td>
                                    ...
                                    <td width="4"><img src="images/nv_2_l.jpg" width="4" height="28" alt=""></td>
                                  </tr>
...
{else}
<center><b>There is no audio in this channel</b></center>
{/if}
